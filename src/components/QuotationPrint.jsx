...
export default function QuotationPrint({
    ...
    return (
        <>
            <div className="quotation-print-wrapper min-h-screen bg-slate-100 p-3 sm:p-6">
                    ...
                    <div className="grid grid-cols-1 gap-5 border-t border-slate-200 px-6 py-6 sm:grid-cols-2 sm:px-10">
                        ...
                        <div>
                            ...
                            <ul className="mt-3 space-y-1 text-xs leading-5 text-slate-500">
                                ...
                                <li>
                                    • This quotation is valid as per the agreed quotation terms.
                                </li>
                                ...
                                <li>
                                    • Final billing will be based on actual supply.
                                </li>

                                <li>
                                    • Payment terms are as mutually agreed.
                                </li>
